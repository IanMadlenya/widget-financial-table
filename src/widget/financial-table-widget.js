...
RiseVision.Financial.prototype.setParams = function(name, value) {
  ...
  if (name[1] && name[1] === "additionalParams" && value[1]) {
    ...
    styleNode.appendChild(document.createTextNode(additionalParams["heading_font-style"]));
    styleNode.appendChild(document.createTextNode(additionalParams["data_font-style"]));        
    ...
    financial.fields = additionalParams.columns;	    
